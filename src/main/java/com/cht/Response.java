...
public class Response<T> implements Serializable {
    ...
    public static Response createError(BaseEnumInterface error) {
        return createError(error.getMsg(), error.getCode());
    }

    public static Response createError(BaseEnumInterface error, Object obj) {
        return createError(error.getMsg(), error.getCode(), obj);
    }
